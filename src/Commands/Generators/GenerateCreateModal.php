...
class GenerateCreateModal extends BaseGenerator
{

    protected $classType = "component-create-modal";
     ...
     * @var string
     */
    protected $signature = 'admin:create-modal
     ...
     * @var string
     */
    protected $description = 'Generates a livewire create modal for the model';
    ...
    {
        $this->info('Generating Create Modal Component Class');
