...
class GenerateCreateModalView extends BaseGenerator
{
     ...
     * @var string
     */
    protected $signature = 'admin:create-modal-view {table : table to generate crud for } {--user : When added the crud is generated for a user model}';
