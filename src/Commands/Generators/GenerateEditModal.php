...
class GenerateEditModal extends BaseGenerator
{

    protected $classType = "component-edit-modal";
     ...
     * @var string
     */
    protected $signature = 'admin:edit-modal
    ...
    {
        $this->info('Generating Edit Modal Component Class');
