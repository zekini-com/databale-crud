...
class GenerateTableActions extends BaseGenerator
{

    protected $classType = 'table-actions';
     ...
     * @var string
     */
    protected $signature = 'admin:table-actions {table : table to generate crud for } {--user : When added the crud is generated for a user model}';
     ...
     * @var string
     */
    protected $description = 'Generates table actions';
    ...
    public function handle(Filesystem $files)
    {
       ...
       $filename = $path.DIRECTORY_SEPARATOR.'table-actions.blade.php';
