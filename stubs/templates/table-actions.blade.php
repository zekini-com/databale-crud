<div class="flex space-x-1 justify-around">
    <button onclick="Livewire.emit('openModal', '{{strtolower($resourcePlural)}}.edit', {{'@'}}js(['id'=>$id]))" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
    ...
    <button onclick="Livewire.emit('openModal', '{{strtolower($resourcePlural)}}.delete', {{'@'}}js(['modelId'=>$id]))">
